  ...
  <div class="uploadWrapper">
    ...
    >
      ...
      >
        ...
        <div v-show="showDelete || roleId==='1'" class="shadow" @click="onRemoveHandler(index)">
      ...
      <el-upload
        ...
        class="uploadBox"
        :style="{ width: width + 'px', height: height + 'px' }"
        action="https://bees-server-dev.ab-inbev.cn/basic-service/basic-service/file-upload-oss"
        :headers="{'authentoken': token, 'type':1}"
        name="uploadFile"
        ...
        :on-exceed="onExceed"
      >
        <i class="el-icon-plus uploadIcon" style="width:100px;height:100px">
...
import { validImgUpload } from '@/utils/valiImg'
